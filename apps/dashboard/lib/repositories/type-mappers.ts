...
//   return permission as EProjectPermission;
// };
...
export const mapSchema = (
  ...
  return {
    ...
    fields: schema.fields ? JSON.parse(JSON.stringify(schema.fields)) : [],
...
export const mapProject = (
  ...
  return {
    ...
    permission: project.permission as EProjectPermission,
