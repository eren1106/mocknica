...
const RichTextEditor = ({
  ...
  return (
    <>
      {/* TODO: make it expandable to a certain height */}
...
const RichTextEditorToolbar = ({ editor }: { editor: Editor }) => {
  return (
    <div className="w-full border border-input bg-transparent rounded-br-md rounded-bl-md p-1 flex flex-row items-center gap-1">
      <Toggle
        size="sm"
