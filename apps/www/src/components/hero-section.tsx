    ...
    <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center mb-8 animate-in fade-in slide-in-from-bottom-3 duration-700">
            <Badge
              variant="secondary"
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-5 duration-700 delay-200">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300">
            <LinkButton
              size="lg"
          ...
          {/* Trust Indicators */}
          <p className="text-sm text-muted-foreground animate-in fade-in slide-in-from-bottom-7 duration-700 delay-400">
            No credit card required · Self-host anywhere · MIT License
          </p>
        </div>

        {/* Demo Video - Full Width Below Content */}
        <div className="max-w-5xl mx-auto mt-16 md:mt-20 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
