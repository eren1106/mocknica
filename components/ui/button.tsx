  ...
  "cursor-pointer inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        // SELF ADDED
        text: "text-background-foreground hover:text-primary",
      },
      size: {
        ...
        // SELF ADDED
        rounded: "h-10 px-4 py-2 rounded-full" // same as default, but with rounded-full
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        ref={ref}
        // added by me, because in default it is in "submit" type, but i dont want that because it will trigger form
        type="button"
        {...props}
      />
    )
